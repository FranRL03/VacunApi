...
INSERT INTO USERS (id, username, email, password, account_non_expired, account_non_locked,credentials_non_expired, enabled, rol) VALUES ('1cef9086-93a1-49de-b5e7-fb3d01d44baa', 'DOCTOR01', 'doctor@example.com', '{bcrypt}$2a$12$qG8MR/W6ExYtPPdpr2Ry/eEy.x30mvHWlRyLuG6fP57lCK.6Kuz.W', true, true, true, true, 'DOCTOR');
...
INSERT INTO USERS (id, username, email, password, account_non_expired, account_non_locked,credentials_non_expired, enabled, rol) VALUES ('1cef9086-93a1-49de-b5e7-fb3d01d44bab', 'DOCTOR02', 'doctor2@example.com', '{bcrypt}$2a$12$qG8MR/W6ExYtPPdpr2Ry/eEy.x30mvHWlRyLuG6fP57lCK.6Kuz.W', true, true, true, true, 'DOCTOR');
INSERT INTO DOCTOR (id, name, last_name, speciality, phone) VALUES ('1cef9086-93a1-49de-b5e7-fb3d01d44bab', 'DOCTOR02', '2', 'Alergologo', '654987321');

INSERT INTO USERS (id, username, email, password, account_non_expired, account_non_locked,credentials_non_expired, enabled, rol) VALUES ('1cef9086-93a1-49de-b5e7-fb3d01d44bac', 'PATIENT01', 'patient@example.com', '{bcrypt}$2a$12$qG8MR/W6ExYtPPdpr2Ry/eEy.x30mvHWlRyLuG6fP57lCK.6Kuz.W', true, true, true, true, 'PATIENT');
...
INSERT INTO APPOINTMENT (id, start_date_time, end_date_time, reason, notes, room, status, patient_id, doctor_id) VALUES ('3cef9086-93a1-49de-b5e7-fb3d01d44bac', '2026-07-07 10:00', '2026-07-07 10:20', 'revision 3', '', 'Room 3-A', 'CANCELED', '1cef9086-93a1-49de-b5e7-fb3d01d44bac', '1cef9086-93a1-49de-b5e7-fb3d01d44baa');
INSERT INTO APPOINTMENT (id, start_date_time, end_date_time, reason, notes, room, status, patient_id, doctor_id) VALUES ('3cef9086-93a1-49de-b5e7-fb3d01d44bad', '2026-07-28 10:00', '2026-07-28 10:20', 'revision', '', 'Room 1-A', 'PENDING', '1cef9086-93a1-49de-b5e7-fb3d01d44bac', '1cef9086-93a1-49de-b5e7-fb3d01d44baa');
